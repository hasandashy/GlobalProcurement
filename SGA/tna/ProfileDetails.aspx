                    ...
                    <div class="dis-block clearfix">
                        <div class="dis-block clearfix member-info ">
                            ...
                            <ul>
                                ...
                                <li><a href="#" onclick="SaveData(6)">Procurement Manager/Leader</a></li>
                                <li><a href="#" onclick="SaveData(5)">Category Manager</a></li>
                                <li><a href="#" onclick="SaveData(4)">Supplier Relationship Manager (VM)</a></li>
                                <li><a href="#" onclick="SaveData(23)">Contract Manager</a></li>
                                <li><a href="#" onclick="SaveData(3)">Strategic Sourcing Specialist</a></li>
                                ...
                                <li><a href="#" onclick="SaveData(28)">Purchasing Administrator</a></li>
                                <li><a href="#" onclick="SaveData(29)">Contract Administrator</a></li>
