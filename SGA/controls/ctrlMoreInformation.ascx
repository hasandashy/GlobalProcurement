...
<p>
    <input type="text" autocomplete="off" value="First name" title="First name" class="txt-field1"
        id="FName" maxlength="100" /></p>
<p>
    <input type="text" autocomplete="off" value="Last name" title="Last name" class="txt-field1"
        id="LName" maxlength="100" /></p>
<p>
    <input type="text" autocomplete="off" value="Company name" title="Company name" class="txt-field1"
        id="CName" maxlength="100" /></p>
<p>
    <input type="text" autocomplete="off" value="Email address" title="Email address" class="txt-field1"
