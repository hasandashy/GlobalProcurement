<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contribute.aspx.cs" Inherits="SGA.Contribute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container ">
        <div class="heading two-line  marT50 marB50">
            <h2>Your invitation to contribute to the <span>Global Procurement Capability Benchmark.</span></h2>
            <p>
                We are collecting IDEAS from the community in preparation for this important project - would you like to contribute? In particular we would love to hear from you if you have fantastic assessment questions or topics to offer. 
    ...
    <div class="block1 greybg padtop-none full-graybg ">
                        ...
                        <div class="dis_block clearfix">
                            ...
                            <div class="form-group">
                                ...
                                <select id="jobRole" name="jobRole" class="form-control">
                                    ...
                                    <option value="6">Procurement Manager/Leader</option>
                                    <option value="5">Category Manager</option>
                                    <option value="4">Supplier Relationship Manager (VM)</option>
                                    <option value="23">Contract Manager</option>
                                    <option value="3">Strategic Sourcing Specialist</option>
                                    ...
                                    <option value="28">Purchasing Administrator</option>
                                    <option value="29">Contract Administrator</option>
		...
		<option value="12">Non-Procurement: Trainee</option>-->
                            ...
                            <div class="form-group">
                                ...
                                <textarea required id="inf_field_Tellus" style="height: 100px" name="inf_field_Tellus" class="form-control" placeholder="Tell us why you are a worthy contributor"></textarea>
                            </div>
