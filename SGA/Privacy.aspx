<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Privacy.aspx.cs" Inherits="SGA.Privacy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<span class="dotline top1 bdrt1"></span>
  <div class="commercially-strip ">
  <div class="container"><span>Privacy Policy</span></div>
  </div>
				...
				<article id="container">
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li>information collected when you undertake assessment at the Procurement Development Centre</li>
                    ...
                    <p>
                        ...
                        <div  style="padding-left:30px;">
                        <ul>
                            <li>provide your Skills Gap Test and Training Needs Analysis results to your employer, where your employer contracts with Comprara to deliver a Procurement Maturity Profile</li>
                        ...
                        <div  style="padding-left:30px;">
                        <ul>
                            <li>professional program providers</li>
                            <li>your employer for the purposes specified in this Privacy Statement</li>
                            <li>partners so that they may contact you about their products and services</li>
                    ...
                    <ul>
                        ...
                        <li>Contacting us at Level 6, 365 Little Collins St, Melbourne Vic, 3000. We may charge a reasonable administration fee for this access.</li>
                    </ul></div>
                    </p>
                    <div class="clear pt10"></div>
                    <b class="bold">COMPLAINTS ABOUT PRIVACY</b>
                    <p>If you have any complaints about our privacy practices, please feel free to send in details of your complaints to Level 6, 365 Little Collins St, Melbourne Vic, 3000. We take complaints very seriously and will respond shortly after receiving written notice of your complaint.</p>
                    <div class="clear pt10"></div>
