...
namespace SGA.ifpsmtna
{
    public partial class procurement_knowledge_evaluation_test : System.Web.UI.Page
    {
        ...
        {
            SGACommon.AddPageTitle(this.Page, "Procurement Benchmark Assessment", "");
        ...
        public void setPrevButton()
        {
            ...
            this.lnkNext.Visible = (this.PageNumber != 6);
            this.btnNextNoForward.Visible = (this.PageNumber == 6);
        }
