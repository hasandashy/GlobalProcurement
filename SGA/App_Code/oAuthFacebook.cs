...
namespace SGA.App_Code
{
...

    {
        ...
        public string CALLBACK_URL = ConfigurationManager.AppSettings["Facebook-CallbackUrl"].ToString();
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = ConfigurationManager.AppSettings["FacebookAppId"].ToString(); //"1190927330948855"; //Your application ID
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = ConfigurationManager.AppSettings["FacebookAppSecret"].ToString(); //"41f85d3ba04ac154bf2bf8705c40d2ee"; //Your application secret
                }
