                                ...
                                <td>
                                     <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="company" SortExpression="company" ItemStyle-Width="15%" HeaderText="Company" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="email" SortExpression="email" ItemStyle-Width="15%" HeaderText="Email Address" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="jobTitle" SortExpression="jobTitle" ItemStyle-Width="10%" HeaderText="Job Title" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="phone" SortExpression="phone" ItemStyle-Width="10%" HeaderText="Phone" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="city" SortExpression="city" ItemStyle-Width="10%" HeaderText="City" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="interest" SortExpression="interest" ItemStyle-Width="10%" HeaderText="Interest" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="needs" SortExpression="needs" ItemStyle-Width="10%" HeaderText="Needs" HeaderStyle-Width="10%" >
                                                    </asp:BoundColumn>
