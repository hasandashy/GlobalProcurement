<%@ Page Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Manage-diagnostic-needs-analysis.aspx.cs" Inherits="SGA.webadmin.Manage_diagnostic_needs_analysis" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    DIAGNOSTIC NEEDS ANALYSIS ASSESSMENT
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" autocomplete="off" name="txttopicTitle" id="txttopicTitle" class="txtBig" runat="server" maxlength="250" />
                                                    ...
                                                    <td>
                                                        <asp:DataGrid ID="grdQuestions" runat="server" AllowPaging="false" AllowSorting="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Question text" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="38%"
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtHintWord" id="txtHintWord" runat="server"  maxlength="500" />
                                                        ...
                                                        <asp:DataGrid ID="grdOptions" runat="server" AllowPaging="false" AllowSorting="false"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundColumn DataField="optionId" HeaderText="Option id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                 ...
                                                                 <asp:BoundColumn DataField="questionId" HeaderText="Question id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                    ItemStyle-Width="3%" HeaderStyle-Width="8%"></asp:BoundColumn>
                                                                <asp:TemplateColumn HeaderText="Option text" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="50%"
                                                                ...
                                                                <asp:BoundColumn DataField="hintWord" HeaderText="Hint Word" ItemStyle-HorizontalAlign="Left"
                                                                    ItemStyle-Width="11%" HeaderStyle-Width="11%"></asp:BoundColumn>
                                                                <asp:TemplateColumn HeaderText="Option<br>Marks" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="6%"
                                                                    HeaderStyle-Width="6%" >
                                                                    <ItemTemplate>
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtOptionMark" id="txtOptionMark" runat="server"  maxlength="4" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtOptionHintWord" id="txtOptionHintWord" runat="server"  maxlength="500" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <textarea id="txtOptionHintText" runat="server" rows="6" cols="80">
                                                                    </textarea>
