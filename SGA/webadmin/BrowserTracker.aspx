                                     ...
                                     <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" autocomplete="off" name="txtEmail" id="txtEmail" class="autosuggest" runat="server" maxlength="250" />
                                                                </td>
                                                                <td class="txtrht">
                                                                    Browser name
                                                                </td>
                                        ...
                                        Text="Cancel" CssClass="rdbut" OnClick="lnkCancel_Click"  ></asp:LinkButton>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="company" SortExpression="company" ItemStyle-Width="15%" HeaderText="Company name" HeaderStyle-Width="15%" >
                                                    </asp:BoundColumn>
