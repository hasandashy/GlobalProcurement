...
{
    public partial class ManageReviewAssess : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewTopicsAdmin");
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewQuestionsAdmin", new SqlParameter[]
            {
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewOptionsAdmin");
        ...
        protected void imgSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateReviewTopicDetail", new SqlParameter[]
                {
        ...
        protected void imgUpdateQuestion_Click(object sender, ImageClickEventArgs e)
        {
            if (this.Page.IsValid)
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateReviewQuestionAdmin", new SqlParameter[]
                {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            if (this.Page.IsValid)
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateAdminReviewOptions", new SqlParameter[]
                {
        ...
        protected void dtgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewTopic", new SqlParameter[]
                {
        ...
        protected void grdQuestions_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewQuestionDetail", new SqlParameter[]
                {
        ...
        protected void grdOptions_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetReviewOptionDetail", new SqlParameter[]
                {
