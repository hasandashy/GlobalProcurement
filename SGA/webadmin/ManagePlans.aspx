                        ...
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            ...
                            <tr>
                                <td>
                                    <div id="tabs">
                                        <ul >
                                            <li><a href="#tabs-3">Procurement Benchmark Assessment</a></li>
                                        ...
                                        <div id="tabs-3">
                                                ...
                                                <tr>
                                                    <td class="hd20">
                                                        MANAGE Procurement Benchmark Assessment Plans
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCMCPlanName" CssClass="txtBig" runat="server" MaxLength="250" style="width:698px;" ValidationGroup="ssa"></asp:TextBox>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCMCPlanCompletionTime" CssClass="txtBig" runat="server" MaxLength="250" style="width:698px;" ValidationGroup="ssa"></asp:TextBox>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <FCKeditorV2:FCKeditor ID="txtCMCPlanDetails" runat="server" Height="400px" Width="703px"></FCKeditorV2:FCKeditor>
                                                                </td>
