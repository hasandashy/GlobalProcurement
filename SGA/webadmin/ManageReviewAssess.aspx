<%@ Page  Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageReviewAssess.aspx.cs" Inherits="SGA.webadmin.ManageReviewAssess" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    Manage Review Assessment Management
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" autocomplete="off" name="txttopicTitle" id="txttopicTitle" runat="server" maxlength="250" />
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtOptionText" id="txtOptionText" runat="server"  maxlength="2" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtOptionLevel" id="txtOptionLevel" runat="server"  maxlength="20" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="text" autocomplete="off" name="txtOptionValue" id="txtOptionValue" runat="server"  maxlength="2" />
